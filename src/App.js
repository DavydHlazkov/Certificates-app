  ...
  return (
    <div className='app'>
      <div className='certificate-list'>
        <CertificateList select={select} certificates = {listFiles} onClick = {certificateOnClickHandler} drag={drag}/>
      { !drag 
      ...
      : <div className='grag-area'>Виберіть сертифікат, щоб переглянути інформацію</div>
    }
    </div>
  );
}
